...
export function WhoWeAreSection() {
  ...
  const yIconDribble = useTransform(
    sectionScroll.scrollYProgress,
    [0.5, 1],
    ["96%", "-96%"],
  );
  const yIconSasss = useTransform(
    sectionScroll.scrollYProgress,
    [0.2, 0.7],
    ["-48%", "48%"],
  );
  const yIconFigma = useTransform(
    sectionScroll.scrollYProgress,
    [0, 0.5],
    ["24%", "-24%"],
  );
        ...
        >
          ...
          <div className="w-[75%]">
            ...
            <p className="mt-8 text-base">
              ...
              maintaining up-to-date industry knowledge, committed to continual
              development — we're always on top of the ever-evolving trends in
              our industry
            </p>
